            ...
            <div className="flex items-center text-white">
              <div className="flex-shrink-0">
                <img
                  ...
                  src={urlLogo}
                  alt="..."
                  onClick={() => { setIsOpen(false), navigate('/home') }}
                />
              </div>
              {check ?
                <NavLink to='/profile' className="rounded-lg px-3 test py-2 font-medium hover:text-slate-500"
                  onClick={() => { setIsOpen(false) }}
                >Profile</NavLink>
                : 
                <NavLink className="text-white ml-3 mr-3" to='/login'
                 onClick={() => { setIsOpen(false) }}
                >Login</NavLink>
              }
              ...
              <NavLink to='/search' className='text-white mr-3 ' onClick={() => { setIsOpen(false) }}>
                <svg
                  class="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
